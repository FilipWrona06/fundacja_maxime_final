 ...
 */
export const gentleSpring = { type: 'spring', stiffness: 100, damping: 20 } as const;
 ...
 */
export const smoothSpring = { type: 'spring', stiffness: 300, damping: 30 } as const;

/**
 * Szybkie i płynne przejście, idealne do animacji wsuwania tła przy najechaniu.
 */
export const hoverTransition = { duration: 0.4, ease: [0.22, 1, 0.36, 1] } as const;
