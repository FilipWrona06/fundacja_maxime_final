...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      validation: (Rule) => Rule.required().error('Wideo w formacie WebM jest wymagane.'),
    }),
    defineField({
      name: 'videoMp4',
      ...
      validation: (Rule) => Rule.required().error('Wideo w formacie MP4 jest wymagane jako fallback.'),
    }),
    defineField({
      name: 'poster',
      ...
      validation: (Rule) => Rule.required().error('Plakat wideo jest wymagany.'),
    }),
  ],
})