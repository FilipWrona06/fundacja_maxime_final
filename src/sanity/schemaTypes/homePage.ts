  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'headingPart1', title: 'Nagłówek - część 1', type: 'string', initialValue: 'Tworzymy' }),
        defineField({ name: 'headingPart2', title: 'Nagłówek - część 2 (żółty)', type: 'string', initialValue: 'Niezapomniane' }),
        defineField({ name: 'headingPart3', title: 'Nagłówek - część 3', type: 'string', initialValue: 'Doświadczenia' }),
        ...
        defineField({ name: 'imageAlt', title: 'Tekst alternatywny zdjęcia', type: 'string' }),
      ]
    }),
    // --- Impact Section ---
    defineField({
        ...
        type: 'object',
        fields: [
            defineField({ name: 'heading', title: 'Nagłówek', type: 'string', initialValue: 'Nasz Wpływ' }),
            ...
            defineField({
                ...
                of: [{
                    type: 'object',
                    fields: [
                        defineField({ name: 'title', title: 'Tytuł karty', type: 'string' }),
                        defineField({ name: 'desc', title: 'Opis karty', type: 'string' }),
                        defineField({ name: 'image', title: 'Zdjęcie', type: 'image', options: { hotspot: true } }),
    ...
    defineField({
        ...
        type: 'object',
        fields: [
            defineField({ name: 'heading', title: 'Nagłówek', type: 'string', initialValue: 'Nasza Historia' }),
            defineField({ name: 'subheading', title: 'Podtytuł', type: 'string' }),
            defineField({
                name: 'timelineEvents',
                ...
                of: [{
                    type: 'object',
                    fields: [
                        defineField({ name: 'year', title: 'Skrócony rok (np. 22)', type: 'string' }),
                        defineField({ name: 'fullYear', title: 'Pełny rok (np. 2022)', type: 'string' }),
    ...
    defineField({
        ...
        type: 'object',
        fields: [
            defineField({ name: 'heading', title: 'Nagłówek', type: 'string', initialValue: 'Czekamy na ciebie' }),
