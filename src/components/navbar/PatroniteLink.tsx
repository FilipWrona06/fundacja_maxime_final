...
import { hoverTransition, iconPopTransition, shineTransition, smoothSpring } from '@/lib/animations';
...
export const PatroniteLink = ({ isMobile = false, onClick }: PatroniteLinkProps) => {
        ...
        >
            ...
            >
                ...
                <motion.span
                    ...
                    animate={isHovered ? { scale: [1, 1.2, 1], rotate: [0, -10, 10, -10, 0] } : { scale: 1, rotate: 0 }}
