    ...
    <section className="container mx-auto px-4 pb-20 sm:px-6 lg:px-8">
      ...
      <MotionWrapper className="mb-16 text-center">
        <div className="mb-6 flex items-center justify-center gap-3">
          <span className="h-px w-12 bg-gradient-to-r from-transparent to-arylideYellow/60" />
  ...
  return (
    <MotionWrapper variant="scale" className="h-full">
      <Link
        ...
        className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/[0.06] bg-gradient-to-br from-white/[0.08] to-white/[0.02] shadow-premium backdrop-blur-2xl transition-all duration-500 hover:-translate-y-2 hover:border-arylideYellow/20 hover:shadow-2xl hover:shadow-arylideYellow/10"
      >
        {/* Decorative top accent */}
        <div className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-arylideYellow/20 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
        ...
        <div className="relative aspect-video w-full overflow-hidden sm:aspect-4/3">
          ...
          {/* Multi-layer overlay */}
          <div className="absolute inset-0 bg-gradient-to-t from-raisinBlack via-raisinBlack/60 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-br from-arylideYellow/[0.03] via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />

          {/* Premium date badge */}
          <div className="absolute left-4 top-4 flex items-center gap-2 rounded-xl border border-white/[0.08] bg-raisinBlack/90 px-3 py-2 text-sm font-bold text-white backdrop-blur-xl shadow-lg transition-all duration-500 group-hover:border-arylideYellow/30 group-hover:bg-raisinBlack/95">
        ...
        <div className="relative flex flex-1 flex-col p-6">
          {/* Subtle glow effect */}
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-arylideYellow/[0.02] via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
          ...
          <div className="relative z-10 mt-auto flex items-center justify-between border-t border-white/[0.06] pt-4">
            ...
            <div className="flex items-center gap-2.5 rounded-lg bg-gradient-to-r from-arylideYellow/10 to-arylideYellow/5 px-3 py-1.5 text-sm font-bold text-arylideYellow transition-all duration-500 group-hover:from-arylideYellow/15 group-hover:to-arylideYellow/8">
