// Plik: src/components/contact/ContactCta.tsx
// (Usuń .client z nazwy pliku i usuń "use client" z góry)
...
export const ContactCta = ({ email }: { email: string }) => {
  return (
    <section>
      <div className="container mx-auto px-6">
        {/*
           Używamy MotionWrapper jako kontenera animacji.
           Zawartość w środku renderuje się statycznie na serwerze.
        */}
        <MotionWrapper
          variant="fadeUp"
          duration={0.8}
