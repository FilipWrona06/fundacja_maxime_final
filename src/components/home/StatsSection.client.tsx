...
// Mapa ikon pozostaje po stronie klienta, bo jest używana do renderowania w JSX.
...
// Prywatny komponent kliencki - w całości odpowiedzialny za renderowanie interaktywnej siatki.
