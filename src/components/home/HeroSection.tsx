...
// KROK 1: Zmieniamy importy, aby używać LazyMotion i 'm'
import {
  LazyMotion,
  domAnimation,
  m,
...
export const HeroSection = ({
  ...
  // Cała logika hooków pozostaje bez zmian
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        >
          ...
          >
            <m.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/wydarzenia"
                className="group relative inline-flex items-center gap-3 rounded-full bg-arylideYellow px-10 py-5 text-base font-bold text-raisinBlack shadow-2xl shadow-arylideYellow/30 transition-all duration-300 hover:shadow-arylideYellow/50"
              >
            ...
            <m.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/kontakt"
                className="group inline-flex items-center gap-3 rounded-full border-2 border-white/30 bg-white/5 px-10 py-5 text-base font-bold text-white backdrop-blur-md transition-all duration-300 hover:border-arylideYellow/60 hover:bg-white/10"
              >
        ...
        >
          <FiArrowDown
            size={36}
            className="text-arylideYellow/80"
            aria-hidden="true"
          />
        </m.button>
      </section>
